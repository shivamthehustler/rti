      ...
      <div className="w-full max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto flex flex-col items-center text-center relative z-10 space-y-6 sm:space-y-8 md:space-y-9">
        ...
        <div className="w-full max-w-2xl sm:max-w-3xl mx-auto">
          ...
          >
            ...
            {/* Intuitive Clear / Reset Button */}
            {searchQuery && (
              <button
                type="button"
                onClick={handleReset}
                className="p-1 sm:p-1.5 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors cursor-pointer mr-0.5 active:scale-90"
                title="Clear search / Reset (Esc)"
        ...
        {/* Centered Curated Prompt Suggestion Chips across 10 Government of India Sectors in Multiple-Line Design */}
        <div className="space-y-2.5 w-full max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 max-w-4xl w-full">
