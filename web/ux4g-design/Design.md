...
| Flutter (deprecated) | pub.dev `ux4g_flutter_design_system` | 0.5.0 | 2026-08-26 |
...
> it still appears in search. It also published 0.5.0 on 2026-08-26 — nine days
...
9. **Version drift across artifacts** (§0, §11) — CDN 3.1.0, npm 1.0.0, pub 1.3.0, Figma 3.0, no published mapping.
